...
enum bt_gatt_hids_c_pm {
	...
	BT_GATT_HIDS_C_PM_REPORT = 0x1  /**< Report protocol */
};
 ...
 * appears.
 * The data size can be obtained from the report object.
 *
 ...
 *
 * @note
 * For Protocol Mode value only WriteWithoutResponse is used,
